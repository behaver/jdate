...
class JDate {
  ...
  getJDE() {
    if (this.cache.JDE === undefined) {
      ...
      // 每儒略日为86400秒
      this.cache.JDE = jd + this.calcUTDelay(jd);
    }
  ...
  setJDE(jde) {
    ...
    let jd = jde - this.calcUTDelay(jde);
  ...
  setJ2000(j2000) {
    ...
    // 2451545.0 代表历元 J2000.0 ，即2000年1月1日12:00
    return this.setJDE(j2000 + 2451545.0);
  }
  ...
  getJDEC() {
    if (this.cache.JDEC === undefined) {
      ...
      this.cache.JDEC = this.getJ2000() / 36525;
    }
  ...
  getJDET() {
    if (this.cache.JDET === undefined) {
      ...
      this.cache.JDET = this.getJ2000() / 365250;
    }
